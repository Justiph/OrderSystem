      ...
      <div className="max-h-full w-full max-w-2xl overflow-auto rounded-xl bg-white shadow-2xl shadow-neutral-950/20">
        <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-500">Images are uploaded before product details are saved.</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={submit} className="space-y-5 p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-[160px_1fr]">
            <div className="aspect-square overflow-hidden rounded-xl border border-gray-200 bg-neutral-100">
              {form.imageUrl ? (
                <img src={getImageUrl(form.imageUrl)} alt="" className="h-full w-full object-cover" />
              ) : (
            ...
            <div>
              ...
              <input
                ...
                className="mt-2 block w-full rounded-lg border border-gray-200 bg-white text-sm text-neutral-700 file:mr-4 file:border-0 file:bg-neutral-950 file:px-4 file:py-3 file:text-sm file:font-semibold file:text-white"
              />
              <label className="mt-4 block text-sm font-medium text-neutral-700" htmlFor="imageUrl">
                Image URL
              </label>
              <input
                id="imageUrl"
